  ...
  _createClass(TileUtilities, [{
        ...
        if (tiledLayer.type === 'tilelayer') {
          ...
          tiledLayer.data.forEach(function (gid, index) {
            ...
            if (gid !== 0) {
              ...
              var tileproperties = tiledMap.tilesets[0];
              var key = String(gid - 1);
    ...
    */
    ...
    value: function hitTestIsoTile(sprite, mapArray, gidToCheck, world, pointsToCheck) {
      ...
      var checkPoints = function checkPoints(key) {
        ...
        // Find the point's index number in the map array
        collision.index = _this3.getIndex(point.x, point.y, world.cartTilewidth, world.cartTileheight, world.widthInTiles);
        ...
        if (tiledLayer.type === 'tilelayer') {
          ...
          tiledLayer.data.forEach(function (gid, index) {
            ...
            if (gid !== 0) {
              ...
              // Use the above values to create the sprite's image from
              // the tileset image
              texture = _this4.frame(tileset, tilesetX, tilesetY, world.tilewidth, world.tileheight);
    ...
    */
    ...
    value: function shortestPath(startIndex, destinationIndex, mapArray, mapWidthInTiles) {
      ...
      var heuristic = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 'manhattan';
      var useDiagonalNodes = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : true;
      ...
      var euclidean = function euclidean(testNode, destinationNode) {
        ...
        var vy = destinationNode.row - testNode.row;
        var h = Math.floor(Math.sqrt(vx * vx + vy * vy) * straightCost);
        return h;
      };
      ...
      var diagonal = function diagonal(testNode, destinationNode) {
        ...
        var vy = Math.abs(destinationNode.row - testNode.row);
        var h = 0;
    ...
    {
      var emptyGid = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0;

      var _this5 = this;

      var segment = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 32;
      ...
      var vy = spriteTwo.centerY - spriteOne.centerY;
      ...
      var points = function points() {
        ...
        for (var i = 1; i <= numberOfPoints; i++) {
          ...
          var y = spriteOne.centerY + dy * newMagnitude;
          ...
          var index = _this5.getIndex(x, y, world.tilewidth, world.tileheight, world.widthInTiles);
    ...
    */
    ...
    value: function canChangeDirection() {
      ...
      var down = validDirections.find(function (x) {
        return x === 'down';
      });
      var left = validDirections.find(function (x) {
        return x === 'left';
      });
      var right = validDirections.find(function (x) {
        return x === 'right';
      });
      var atIntersection = (up || down) && (left || right);
...
exports.default = TileUtilities;
module.exports = exports['default'];

/***/ })
/******/ ]);
//# sourceMappingURL=tile-utilities.js.map